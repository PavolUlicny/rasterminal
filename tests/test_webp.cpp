...
{
    // decode_textures() decodes in parallel. libwebp has no global init to guard (unlike the
    // basisu transcoder), but prove reentrancy: every worker must produce identical bytes.
